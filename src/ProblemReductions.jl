...
export num_variables, num_flavors, variables, flavors, flavor_names, weights, set_weights, is_weighted, size, weight_type, problem_size, configuration_space_size
export UnitWeight
